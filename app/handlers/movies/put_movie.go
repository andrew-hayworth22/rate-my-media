...
func (req PutMovieRequest) Valid(ctx context.Context) (problems map[string]string) {
...
func HandlePutMovie(movieStore movies.MovieStore) http.Handler {
	return http.HandlerFunc(
		func(w http.ResponseWriter, r *http.Request) {
			var req PutMovieRequest
			...
			dbMovie, err := movieStore.UpdateMovie(r.Context(), movies.DbUpdateMovieRequest{
				Id:             req.Id,
				Name:           req.Name,
